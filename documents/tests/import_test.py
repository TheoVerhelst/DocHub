...
def test_importer(mock_add_to_queue):
    ...
    Group.objects.create(slug="test-t-100")
    ...
    call_command('import_documents', username="test_user", group_slug="test-t-100", path=tmpdir)
    ...
    assert doc.group.slug == 'test-t-100'
